...
<a type="button" class="text-warning" data-bs-toggle="modal" data-bs-target="#modalEditarCategoria{{$item->id}}">
    <i class="bi bi-pencil "></i>
</a>
    


<div class="modal fade" id="modalEditarCategoria{{$item->id}}" tabindex="-1">
    ...
    <div class="modal-content">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            ...
            <div class="modal-body">
                <form action="{{ route('admin.activos.update', $item->id) }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="col-12 text-start ">
                            ...
                            <div class="input-group has-validation">
                                ...
                                <input type="text" name="nombre" class="form-control" id="yourUsername"
                                    placeholder="Ingrese nombre de la categoria" value="{{ $item->nombre ?? '' }}" required>
