                    ...
                    <div class=" col-sm-8 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="card ">
                            ...
                            <div class="card-body">
                                ...
                                <div class=" pb-2">
                                    <h5 class="card-title text-center pb-0 fs-2">Editar membresia</h5>
                                    <p class="text-center text-danger small">Rellene todos los campos</p>
                                </div>

                                <form action="{{ route('admin.membresias.update', $membresiaDecrypt[5]) }}" method="post" 
                                enctype="multipart/form-data"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group has-validation">
                                            ...
                                            <input type="text" name="paquete" class="form-control" id="paquete"
                                                ...
                                                value="{{ $membresiaDecrypt[0] ?? old('paquete') }}" required>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group has-validation">
                                            ...
                                            <input type="text" name="empresa" class="form-control" id="empresa"
                                                ...
                                                value="{{ $membresiaDecrypt[1] ?? old('empresa') }}" required>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group has-validation">
                                            ...
                                            <input type="text" name="rif" class="form-control" id="rif"
                                                ...
                                                value="{{ $membresiaDecrypt[2] ?? old('rif') }}" required>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group has-validation">
                                            ...
                                            <input type="date" name="fecha_inicio" class="form-control" id="fecha_inicio"
                                                ...
                                                value="{{ $membresiaDecrypt[3] ?? old('fecha_inicio') }}" required>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group has-validation">
                                            ...
                                            <input type="date" name="fecha_fin" class="form-control" id="fecha_fin"
                                                ...
                                                value="{{ $membresiaDecrypt[4] ?? old('fecha_fin') }}" required>
                                    ...
                                    <div class="col-12">
                                        <button class="btn btn-primary w-100" type="submit">Actualizar membresia</button>
                                    </div>
