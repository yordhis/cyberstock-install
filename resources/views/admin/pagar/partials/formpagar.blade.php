        ...
        <div class="modal-body">
            ...
            <form action="{{ route('admin.cuentas.por.pagar.store') }}" method="POST" class="form-floating" >
                ...
                <div class="form-floating mb-3">
                  <h3>Acreedor: <span class="text-danger">{{ $factura->proveedor[0]->empresa }}</span></h3>
                ...
                <div class="form-floating mb-3">
                  <select class="form-select" name="metodo" id="floatingSelect" aria-label="Floating label select example" required>
                    <option selected value="">Seleccione método de pago</option>
                ...
                <div class="input-group mb-3">
                  ...
                  <button type="submit" class="btn btn-primary mt-2" {{ $factura->concepto == "COMPRA" ? "disabled" : "" }}>PROCESAR PAGO</button>
              </form>
