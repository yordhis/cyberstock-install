                                ...
                                <form action="carritos" method="post" target="_self">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-sm-6 col-xs-12 mt-4">
                                            ...
                                            <div class="input-group has-validation">
                                                ...
                                                <input type="number" name="codigo"
                                                    ...
                                                    id="codigo" value="{{ $codigo ?? '' }}" readonly required>
                                        ...
                                        <div class="col-sm-6 col-xs-12 mt-4">
                                            ...
                                            <span id="dataCliente" class="factura card p-3">@isset($carritos[0]['cliente'])<h4>{{ "Cliente: " . $carritos[0]['cliente']->nombre ?? '' }}</h4>@endisset</span>
